package com.mermela.canvassamples.ui.weightpicker
...
import com.mermela.canvassamples.ui.weightpicker.model.LineType
import com.mermela.canvassamples.ui.weightpicker.model.ScaleStyle
...
@Composable
fun CustomWeightPicker(modifier: Modifier = Modifier) {
    Column(
        modifier = modifier,
        horizontalAlignment = androidx.compose.ui.Alignment.CenterHorizontally,
        verticalArrangement = Arrangement.Center
    ) {
        var currentWeight = remember {
            mutableStateOf(68)
        }
        Text(
            text = "${currentWeight.value} kg",
